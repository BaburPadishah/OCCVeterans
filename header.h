...
enum Controls {
	...
	ADMIN_SEARCH_LOGINS_ID_EDIT, ADMIN_SEARCH_LOGINS_NAME_EDIT, ADMIN_PAST_DAY_RADIO, ADMIN_PAST_WEEK_RADIO, ADMIN_PAST_MONTH_RADIO, ADMIN_PAST_YEAR_RADIO, ADMIN_ALL_TIME_RADIO,
